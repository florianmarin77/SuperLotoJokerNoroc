...
public class MainApp extends Application {
    ...
    // Rezolvăm Warning: Field may be 'final'
    private final TableView<Sample> table = new TableView<>();
    private final TableColumn<Sample, Integer> colSpecial = new TableColumn<>("Joker");
    ...
    public void start(Stage stage) {
        ...
        // Rezolvăm Warning: Parameter 'e' is never used (folosim _ pentru eveniment)
        btnLoto.setOnAction(_ -> updateUI(LottoRepository.getInstance().getLotoData(), false, "Statistici Loto 6/49"));
        btnJoker.setOnAction(_ -> updateUI(LottoRepository.getInstance().getJokerData(), true, "Statistici Joker"));
        btnSuper.setOnAction(_ -> updateUI(LottoRepository.getInstance().getSuperData(), false, "Statistici Super 5/40"));
    ...
    // Rezolvăm Warning: Unchecked generics array creation
    ...
    private void setupTable() {
        ...
        // Rezolvăm Warning: CONSTRAINED_RESIZE_POLICY is deprecated
